...
collision_excel_file  = "C:/Users/saiko/OneDrive/Desktop/699/Task-7/collision-output(New).xlsx"
fcd_excel_file = "C:/Users/saiko/OneDrive/Desktop/699/Task-7/fcd-output(New).xlsx"
lane_excel_file = "C:/Users/saiko/OneDrive/Desktop/699/Task-7/lanechange-output(New).xlsx"

collision_df = pd.read_excel(collision_excel_file)
fcd_df = pd.read_excel(fcd_excel_file)
lane_df = pd.read_excel(lane_excel_file)

net_file_path = 'C:/Users/saiko/OneDrive/Desktop/699/Task-7/Highway_route.net.xml'
...
vehicle_density.to_excel('vehicle_density_New.xlsx', index = False)
...
features.to_excel('features_New.xlsx')